  ...
  try {
    ...
    if (Object.keys(data).length == 0) {
      ...
      res
        ...
        .send({
          status: false,
          msg: "college Name should only have lower case letters only",
        });
    } else if (fiterName) {
      res
        .status(400)
        .send({
          status: false,
          msg: "this college name already exist in collection",
        });
      ...
      res
        ...
        .send({
          status: false,
          msg: "plese enter the fullName of your college",
        });
      ...
      res
        .status(400)
        .send({ status: false, msg: "plese enter valid logoLink" });
